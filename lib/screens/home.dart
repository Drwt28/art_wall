...
class _HomeScreenState extends State<HomeScreen> {
              ...
              child: ListTile(
                onTap: () {
                  ...
                  showAboutDialog(
                      ...
                      children: [
                        Image.asset('assets/Art_wall.png'),
                        Center(
  ...
  Future _searchWalpapers(String query) async {
    http.Response response = await http.get(
        'https://api.unsplash.com/search/photos/?client_id=$kAccessKey&query=$query&per_page=30&page=$_page');
    _parsedResponse = json.decode(response.body);
    print(_parsedResponse.toString());
    return _parsedResponse;
  }
}
